					...
					<div class="form-group">
						<div class="row">
							<div class="col-sm-4">
								...
								{!! Form::select('display', CommonOption::displayTypeArray(), old('display'), array('class' =>'form-control', 'onchange' => 'loadRelation()')) !!}
							</div>
							<div class="col-sm-4">
								...
								{!! Form::select('relation_id', array_add($relationArray, '0', '-- chọn'), 0, array('class' =>'form-control')) !!}
							</div>
						</div>
					</div>
					<div class="form-group">
