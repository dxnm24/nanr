...
class CommonMethod
{
	...
	static function replaceText($string='')
	{
		...
		$replacements[0] = '<form method="POST" action="/contact">'.$csrf_field.'<div class="row"><div class="small-3 columns"><label for="contact-name" class="text-right">Họ Tên</label></div><div class="small-9 columns"><input type="text" id="contact-name" name="name" required /></div></div><div class="row"><div class="small-3 columns"><label for="contact-email" class="text-right">Email</label></div><div class="small-9 columns"><input type="email" id="contact-email" name="email" required /></div></div><div class="row"><div class="small-3 columns"><label for="contact-tel" class="text-right">Điện Thoại</label></div><div class="small-9 columns"><input type="text" id="contact-tel" name="tel" /></div></div><div class="row"><div class="small-3 columns"><label for="contact-msg" class="text-right">Tin Nhắn</label></div><div class="small-9 columns"><textarea id="contact-msg" name="msg" rows="3"></textarea></div></div><div class="row"><div class="small-3 columns"></div><div class="small-9 columns"><input type="submit" value="Gửi Tin Nhắn" class="button" /></div></div></form>';
